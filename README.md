...
* [[AmateurRadioIcons from this repository](https://github.com/HochdruckHummer/WavelogQSOStats2Awtrix/tree/main/AmateurRadioIcons)]AmateurRadioIcons from this repository  uploaded to the Awtrix' /ICON/ folder
